# 2017.05.04 15:28:17 Støední Evropa (letní èas)
...
class ClientClubs(object):
    ...
    def __updateClubData(self, clubDBID, clubData):
        ...
        if callable(updater):
            updater(clubDBID, clubData)
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client_common\shared_utils\account_helpers\ClientClubs.pyc 
