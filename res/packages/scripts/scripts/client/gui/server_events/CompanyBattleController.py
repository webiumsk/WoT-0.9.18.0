# 2017.05.04 15:25:31 Støední Evropa (letní èas)
...
class CompanyBattleController(Notifiable):
    ...
    def __handlePostponed(self):
        ...
        self.__delayedCompanyState = []
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\server_events\CompanyBattleController.pyc 
