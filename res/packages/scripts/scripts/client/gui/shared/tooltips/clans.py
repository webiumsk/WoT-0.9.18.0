# 2017.05.04 15:26:12 Støední Evropa (letní èas)
...
class ClanProfileFortBuildingTooltipData(BlocksTooltipData, FortTransportationViewHelper):
    ...
    def isOnNextTransportingStep(self):
        return False
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\clans.pyc 
