# 2017.05.04 15:25:45 Støední Evropa (letní èas)
...
def createByState(state, isLeader = False, exclude = None):
    ...
    return None
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\fortifications\controls.pyc 
