# 2017.05.04 15:25:47 Støední Evropa (letní èas)
...
class DefenceItem(_BattleItemAbstract):
    ...
    def isLose(self):
        return self.isResultsPresent() and self._attackResult > 0 or self._attackResult == FORT_ATTACK_RESULT.TECHNICAL_DRAW
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\fortifications\fort_seqs.pyc 
