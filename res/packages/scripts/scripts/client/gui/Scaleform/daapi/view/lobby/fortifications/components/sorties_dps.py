...
class FortBattlesDataProvider(SortableDAAPIDataProvider):
    ...
    def __makeTimeOfBattle(self, item, battleItem, currentState):
        ...
        return result
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\components\sorties_dps.pyc 
