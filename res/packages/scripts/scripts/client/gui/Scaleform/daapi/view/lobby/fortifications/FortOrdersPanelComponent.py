...
class FortOrdersPanelComponent(SlotsPanelMeta, FortViewHelper):
    ...
    def onConsumablesChanged(self, unitMgrID):
        self._buildList()
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortOrdersPanelComponent.pyc 
