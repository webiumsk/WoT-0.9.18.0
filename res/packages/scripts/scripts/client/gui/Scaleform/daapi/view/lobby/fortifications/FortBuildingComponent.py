...
class FortBuildingComponent(FortBuildingComponentMeta, FortTransportationViewHelper):
    ...
    def __makeData(self, animations = None):
        ...
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortBuildingComponent.pyc 
