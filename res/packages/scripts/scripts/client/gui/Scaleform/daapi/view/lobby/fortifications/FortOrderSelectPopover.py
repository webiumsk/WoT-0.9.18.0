...
class FortOrderSelectPopover(FortOrderSelectPopoverMeta, FortViewHelper, IUnitListener):
    ...
    def __updateData(self):
        ...
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortOrderSelectPopover.pyc 
