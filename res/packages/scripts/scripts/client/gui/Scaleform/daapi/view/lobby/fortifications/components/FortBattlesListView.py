...
class FortBattlesListView(FortClanBattleListMeta, FortListener):
    ...
    def __updateSearchDP(self, state):
        if state.getStateID() != CLIENT_FORT_STATE.HAS_FORT:
            ...
            return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\components\FortBattlesListView.pyc 
