...
class FortOrderPopover(FortOrderPopoverMeta, FortViewHelper):
    ...
    def __getFortQuestBonusesStr(cls):
        ...
        return ', '.join(result)
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortOrderPopover.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.05.04 15:23:22 Støední Evropa (letní èas)
