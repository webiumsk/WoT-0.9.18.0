...
class FortBattleDirectionPopover(FortBattleDirectionPopoverMeta, FortViewHelper):
    ...
    def __clearCallback(self):
        if self.__updateCallbackID is not None:
            ...
            self.__updateCallbackID = None
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortBattleDirectionPopover.pyc 
