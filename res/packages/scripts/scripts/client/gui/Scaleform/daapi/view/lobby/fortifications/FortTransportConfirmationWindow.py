...
class FortTransportConfirmationWindow(FortTransportConfirmationWindowMeta, FortViewHelper):
    ...
    def __changeStateAndDestroy(self):
        ...
        self.destroy()
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortTransportConfirmationWindow.pyc 
