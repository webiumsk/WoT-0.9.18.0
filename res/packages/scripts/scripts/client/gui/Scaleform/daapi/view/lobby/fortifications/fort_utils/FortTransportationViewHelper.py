# 2017.05.04 15:23:30 Støední Evropa (letní èas)
...
class FortTransportationViewHelper(FortViewHelper):
    ...
    def __getTransportingBuildTooltipData(self, building):
        ...
        if state is not None:
            ...
            return
            return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\fort_utils\FortTransportationViewHelper.pyc 
