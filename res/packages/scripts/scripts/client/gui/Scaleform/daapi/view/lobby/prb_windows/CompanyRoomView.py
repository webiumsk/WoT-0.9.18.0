# 2017.05.04 15:23:42 Støední Evropa (letní èas)
...
class CompanyRoomView(CompanyRoomMeta):
    ...
    def __handleSetPrebattleCoolDown(self, event):
        if event.requestID is REQUEST_TYPE.SET_PLAYER_STATE:
            ...
            self.as_setCoolDownForReadyButtonS(event.coolDown)
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\CompanyRoomView.pyc 
