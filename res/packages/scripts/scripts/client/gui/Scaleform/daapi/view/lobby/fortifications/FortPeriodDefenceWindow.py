...
class FortPeriodDefenceWindow(FortPeriodDefenceWindowMeta, FortViewHelper):
    ...
    def __setup(self, defHour, offDay, peripheryID):
        ...
        self.destroy()
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortPeriodDefenceWindow.pyc 
