...
class ClanProfileFortificationView(ClanProfileFortificationViewMeta, FortListener):
    ...
    def __showDummyBody(self):
        self.as_showBodyDummyS({'iconSource': RES_ICONS.MAPS_ICONS_LIBRARY_ALERTBIGICON,
         ...
         'btnLabel': '',
         'btnTooltip': ''})
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\profile\ClanProfileFortificationView.pyc 
