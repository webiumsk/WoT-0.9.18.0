...
class ClanProfileFortificationInfoView(ClanProfileFortificationInfoViewMeta):
    ...
    def _dispose(self):
        ...
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\profile\ClanProfileFortificationInfoView.pyc 
