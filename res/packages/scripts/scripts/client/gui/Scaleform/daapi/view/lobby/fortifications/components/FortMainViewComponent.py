...
class FortMainViewComponent(FortMainViewMeta, FortViewHelper, ClanListener):
    ...
    def __showRosterIntroWindow(self, type):
        ...
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\components\FortMainViewComponent.pyc 
