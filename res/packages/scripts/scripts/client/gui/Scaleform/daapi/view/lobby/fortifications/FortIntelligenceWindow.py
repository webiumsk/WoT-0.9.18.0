...
class FortIntelligenceWindow(FortIntelligenceWindowMeta, FortViewHelper):
    ...
    def __setStatus(self, hasResults):
        ...
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortIntelligenceWindow.pyc 
