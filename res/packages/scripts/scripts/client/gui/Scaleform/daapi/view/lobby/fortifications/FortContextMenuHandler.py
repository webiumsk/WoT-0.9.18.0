...
class FortContextMenuHandler(AbstractContextMenuHandler, EventSystemEntity, FortViewHelper):
    ...
    def _generateOptions(self, ctx = None):
        ...
        return result
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortContextMenuHandler.pyc 
