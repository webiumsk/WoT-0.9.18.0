...
class FortIntelligenceClanDescription(FortIntelligenceClanDescriptionMeta, FortViewHelper):
    ...
    def __requestClanEmblem(self):
        if self.__item is not None:
            ...
            self.__makeData()
        return
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\components\FortIntelligenceClanDescription.pyc 
