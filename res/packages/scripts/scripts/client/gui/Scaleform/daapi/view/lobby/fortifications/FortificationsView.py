...
class FortificationsView(LobbySubView, FortificationsViewMeta, FortViewHelper):
    ...
    def __onClanInfoChanged(self, clanInfo):
        if not clanInfo:
            self.__close()
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortificationsView.pyc 
