...
class QuestsCurrentTab(QuestsCurrentTabMeta):
    ...
    def __onEventsUpdated(self, *args):
        ...
        self._invalidateEventsData()
        self._updateFilterView()
# okay decompyling C:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\QuestsCurrentTab.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.05.04 15:23:56 Støední Evropa (letní èas)
